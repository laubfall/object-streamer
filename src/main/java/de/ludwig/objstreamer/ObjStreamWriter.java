 ...
 * objectchunk
 * 
 * Every ObjectChunk is serialized as a Head-Section and a Value-Section.
 * The Head-Section holds the references to the values stored in the Value-Section.
 * 
 * The Head-Section starts with {@link FileConstants#CHUNK_START}.
 * The Value-Section starts with {@link FileConstants#VALUES_START}.
 * 
 * @author Daniel
 * 
 */
public class ObjStreamWriter {
	...
	private final static EnumSet<FileConstants> FIELDS = EnumSet.of(FileConstants.PARENT, FileConstants.FIELD_NAME);
	...
	private void write(RandomAccessFile raf, long currentChunkStartPtr,
		...
		if(fieldName != null){
			...
			// calculate write Position for reference write of the field "field name".
	 ...
	 * @param fieldNum
	 */
	private void write(RandomAccessFile raf, ObjectChunk chunk, short fieldNum){
